...
(*  unit_test(has_cycle list6b); *)
  ...
  (* Tests for flatten *)
  (* unit_test (flatten list2)  "has cycle list2";
  unit_test (flatten list3c) "not has_cycle list3c";
  unit_test (flatten list4a) "not has_cycle list4a";
  unit_test (flatten list5)  "not has_cycle list5";
  unit_test (flatten list6b) "not has_cycle list6b";
  unit_test (flatten list7b) "not has_cycle list7b";
  unit_test (flatten list8b) "not has_cycle list8b"; *)
